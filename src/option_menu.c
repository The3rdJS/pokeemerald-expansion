...
{
    u8 styles[3];
    s32 widthSlow, widthFast, widthNone, xMid;
    ...
    widthNone = GetStringWidth(FONT_NORMAL, gText_TextSpeedNone, 0);

    widthFast -= 94;
    xMid = (widthSlow - widthFast - widthNone) / 2 + 104;
    DrawOptionMenuChoice(gText_TextSpeedFast, xMid, YPOS_TEXTSPEED, styles[1]);

    DrawOptionMenuChoice(gText_TextSpeedNone, GetStringRightAlignXOffset(FONT_NORMAL, gText_TextSpeedNone, 198), YPOS_TEXTSPEED, styles[2]);
}
