...
static const void HexOrb_BufferBlockedStatusMessage(u32 status)
{
    switch (status)
    {
        ...
        case STATUS1_SLEEP:
            ...
            break;
        default:
            StringCopy(gStringVar3,COMPOUND_STRING("status"));
            break;
    }
}
...
static void HexOrb_BufferStatusAfflictionText(u32 status)
{
    switch (status)
    {
        ...
        case STATUS1_FREEZE:
            ...
            break;
        case STATUS1_PARALYSIS:
            StringCopy(gStringVar2, COMPOUND_STRING("was paralyzed"));
            break;
        case STATUS1_SLEEP:
            StringCopy(gStringVar2, COMPOUND_STRING("fell asleep"));
            break;
        default:
            StringCopy(gStringVar2, COMPOUND_STRING("status"));
    }
}
...
{
    return HEX_ORB_BLOCK_STATUS && (GetMonData(mon, MON_DATA_STATUS) & STATUS1_ANY);
}
