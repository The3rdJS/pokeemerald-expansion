...
const u8 gText_NoPokemon[] = _("You have no POKéMON.");
...
const u8 *const gPocketNamesStringsTable[] =
{
    ...
    [ITEMS_POCKET] =     COMPOUND_STRING("OTHER ITEMS"),
...
const u8 gText_TextSpeedNone[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}NONE");
...
const u8 gText_UsedRepel[] = _("{PLAYER} used the Repel.{PAUSE_UNTIL_PRESS}");
const u8 gText_StoppedUsingRepel[] = _("{PLAYER} stopped using the Repel.{PAUSE_UNTIL_PRESS}");
