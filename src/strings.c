...
const u8 gText_ToggleableRepelOn[] = _("{PLAYER} activated the Repel.{PAUSE_UNTIL_PRESS}");
const u8 gText_ToggleableRepelOff[] = _("{PLAYER} deactivated the Repel.{PAUSE_UNTIL_PRESS}");
