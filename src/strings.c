...
const u8 gText_UsedRepel[] = _("{PLAYER} activated the Repel.{PAUSE_UNTIL_PRESS}");
const u8 gText_StoppedUsingRepel[] = _("{PLAYER} deactivated the Repel.{PAUSE_UNTIL_PRESS}");
