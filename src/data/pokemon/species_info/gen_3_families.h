...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_WURMPLE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_FEMALE, 7, SPECIES_SILCOON},
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_POISON_HEAL, ABILITY_QUICK_FEET, ABILITY_EFFECT_SPORE },
    #else
    ...
    [SPECIES_BUDEW] =
    {
        ...
        .abilities = { ABILITY_NATURAL_CURE, ABILITY_NONE, ABILITY_POISON_POINT },
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
        .speciesName = _("Budew"),
        .cryId = CRY_BUDEW,
