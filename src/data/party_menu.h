...
} static const sCursorOptions[MENU_FIELD_MOVES] =
{
    ...
    [MENU_INFLICT_FREEZE]    = {COMPOUND_STRING("Freeze"),          TryHexOrbAndPrintResult},
    [MENU_INFLICT_PARALYSIS] = {COMPOUND_STRING("Para"),            TryHexOrbAndPrintResult},
...
static const u8 sPartyMenuAction_HexOrb[] = {MENU_INFLICT_BURN, MENU_INFLICT_POISON, MENU_INFLICT_FREEZE, MENU_INFLICT_PARALYSIS, MENU_INFLICT_SLEEP, MENU_CANCEL1};
...
static const u8 *const sPartyMenuActions[] =
{
    ...
    [ACTIONS_HEX_ORB]       = sPartyMenuAction_HexOrb,
};
...
static const u8 sPartyMenuActionCounts[] =
{
    ...
    [ACTIONS_HEX_ORB]       = ARRAY_COUNT(sPartyMenuAction_HexOrb),
};
